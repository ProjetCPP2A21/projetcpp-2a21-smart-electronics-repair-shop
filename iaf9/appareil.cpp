...
Appareil::Appareil(QString id, QString type, QString marque, QString modele, QString defaut, QDate dateEntree, QString statut, QString remarques, double prix, QDate dateEstime)
{
    this->id_app = id;
    this->type = type;
    this->marque = marque;
...
{
    QSqlQuery query;
    query.prepare("SELECT ID_APP, TYPE, MARQUE, MODELE, DEFAULTDECLARE, DATEENTREE, STATUT, REMARQUES, PRIXESTIME, DATEESTIME "
