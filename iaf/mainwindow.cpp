...
void MainWindow::on_aretour_clicked(){
    ui->stackedWidget->setCurrentWidget(ui->menu);
}
           // stock(page)
...
{
    ui->stackedWidget->setCurrentWidget(ui->menu_fournisseur);
    if (!clapHandler) {
        clapHandler = new ArduinoFournisseur(this);
    }
    clapHandler->start();
}

void MainWindow::on_fretour_clicked()
{
    if (clapHandler) clapHandler->stop();
    ui->stackedWidget->setCurrentWidget(ui->menu);
}
void MainWindow::on_btnAjouter_9_clicked()        { fourn->ajouterFournisseur(); }
void MainWindow::on_rechercher_2_clicked()        { fourn->rechercherFournisseurParId(ui->menu_fournisseur); }
void MainWindow::on_Modifier_2_clicked()          { fourn->modifierFournisseur(); }
void MainWindow::on_btnSupprimer_2_clicked()      { fourn->supprimerFournisseur(); }
void MainWindow::on_maj_2_clicked()               { fourn->rafraichirListeFournisseurs(); }
void MainWindow::on_tri_3_clicked()               { fourn->trierParNomEntreprise(); }

void MainWindow::on_btnStatistiques_2_clicked()   { fourn->afficherStatistiques(); }
void MainWindow::on_PDF_2_clicked()               { fourn->exporterPDF(); }
void MainWindow::on_mai_1_clicked()               { fourn->afficherScoreFournisseurMA1(); }
void MainWindow::on_mai_2_clicked()               { fourn->afficherFournisseursPrioritairesMA2(); }
