...
bool stock::ajouter()
{
    ...
    query.prepare("UPDATE stock SET NOMPIECE = :nom, REFERENCE = :reference, CATEGORIE = :categorie, QUANTITE = :quantite, "
                  "PRIXACHAT = :prixachat, PRIXVENTE = :prixvente, FOURNISSEUR = :fournisseur, DATELIVRAISON = :datelivraison "
                  "WHERE ID_STOCK = :id");
