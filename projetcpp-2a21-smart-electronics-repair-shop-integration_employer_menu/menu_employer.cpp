    ...
    , ui(new Ui::menu_employer)
{
    ...
    connect(ui->retour_4, &QPushButton::clicked, this, [this]() { goToPage(ui->page_2); });
     connect(ui->stock, &QPushButton::clicked, this, [this]() { goToPage(ui->page_3); });
     connect(ui->retour, &QPushButton::clicked, this, [this]() { goToPage(ui->page_2); });
...
void menu_employer::on_btajouter_stock_clicked()
{
...
void menu_employer::on_btsupprimer_stock_clicked()
{
...
void menu_employer::on_btmodifier_stock_clicked()
{
    int id = ui->lineEdit_IDstock->text().toInt();
    QString nom = ui->lineEdit_nomstock->text();
    QString reference = ui->lineEdit_referencestock->text();
